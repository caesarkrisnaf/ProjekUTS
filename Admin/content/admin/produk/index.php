    ...
    <div class="col-md-12">
        <div class="box">
            <div class="box-header">
                <a href="index.php?page/admin=create_produk" class="btn btn-success btn-md"><span class="fa fa-plus"></span> Tambah</a>
            </div>
            <div class="box-body">
                            ...
                            <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 180.135px;">Jenis Produk</th>
                                        <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending" style="width: 140.573px;">Foto Produk</th>
